// app/admin/writings/_components/PostEditor.tsx
'use client'
...
export default function PostEditor({ initialData }: PostEditorProps) {
  ...
  async function handleSave(publish: boolean) {
    ...
    const url    = isEdit ? `/api/admin/writings/${initialData.id}` : '/api/admin/writings'
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          placeholder="My first writings post"
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs font-mono text-zinc-500">
          Slug — <span className="text-zinc-600">yoursite.com/writings/<span className="text-amber-400">{slug || 'my-first-post'}</span></span>
        </label>
        <input
          type="text"
          value={slug}
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs font-mono text-zinc-500">
          Excerpt — shown on writings list and in Google search results
        </label>
        <textarea
          value={excerpt}
